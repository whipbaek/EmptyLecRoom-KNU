...
public class TimeTable2 extends JFrame{
    ...
    private static final Color newGreen = new Color(204, 255 , 204);
    ...
    public TimeTable2() {
        ...
        timeTableAry.add("화" + ", " + "[" + "12 : 00" + "][" + "18 : 00" + "]");
        timeTableAry.add("월" + ", " + "[" + "14 : 00" + "][" + "18 : 00" + "]");
        timeTableAry.add("월" + ", " + "[" + "14 : 00" + "][" + "18 : 00" + "]");
    ...
    public void stringToTimeTable(ArrayList time) {
        for (int i = 0; i < time.size(); i++) {
            ...
            if (arr.length == 5) {
                coloringTable(arr[0], arr[2], arr[4]); //요일 시작시간 끝나는시간
    ...
    private void coloringTable (String day, String start, String end) {
